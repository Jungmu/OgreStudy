...
public:
	...
	{
		mProfessorNode = root->getSceneManager("main")->getSceneNode("Ninja");
		mProfessorEntity = root->getSceneManager("main")->getEntity("Ninja");
...
public:
	...
	void go(void)
	{
		...
		SceneNode* node1 = mSceneMgr->getRootSceneNode()->createChildSceneNode("Ninja", Vector3(0.0f, 0.0f, 0.0f));
